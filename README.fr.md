...
| --- | --- | --- |
| Docker / Synology Container Manager | Bêta publique `0.1.12` | Serveur, interface navigateur et streaming natif Wi-Fi local gratuits |
...
- **Image Docker :** `ghcr.io/mlt-solutions/bibliofuse-nas:0.1.12`

...
| --- | --- | --- |
| Docker / Synology Container Manager | Bêta publique `0.1.6` | Serveur, interface navigateur et streaming natif Wi-Fi local gratuits |
...
Consultez le [tutoriel Synology](docs/synology-container-manager.md) pour une procédure complète.
...
- **Image Docker :** `ghcr.io/mlt-solutions/bibliofuse-nas:0.1.6`
...
- [Tutoriel Synology Container Manager](docs/synology-container-manager.md)

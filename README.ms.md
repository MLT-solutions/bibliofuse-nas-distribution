...
| --- | --- | --- |
| Docker / Synology Container Manager | Beta awam `0.1.12` | Pelayan percuma, UI pelayar, penstriman asli Wi-Fi setempat |
...
- **Imej Docker:** `ghcr.io/mlt-solutions/bibliofuse-nas:0.1.12`

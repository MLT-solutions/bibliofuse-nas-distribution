...
Deze handleiding installeert de gratis Docker-server en webinterface via Container Manager. Zie voor het afzonderlijk geteste native DSM-pakket de [Synology-pakkethandleiding](synology-package.md).

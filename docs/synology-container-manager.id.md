...
Panduan ini memasang server Docker gratis dan UI web melalui Container Manager. Untuk paket DSM native yang diuji secara terpisah, lihat [panduan paket Synology](synology-package.md).

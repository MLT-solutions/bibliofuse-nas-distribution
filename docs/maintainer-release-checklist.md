...
- [ ] Create a public GitHub repository for these distribution files.
- [ ] Keep the server source repository private.
...
- [ ] Add `.spk` and checksum only after Synology package validation.
...
- [ ] Mark the Synology `.spk` as planned until it is actually downloadable.

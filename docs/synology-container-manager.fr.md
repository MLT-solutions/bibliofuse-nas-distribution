...
Ce guide installe le serveur Docker gratuit et son interface web avec Container Manager. Pour le paquet DSM natif testé séparément, consultez le [guide du paquet Synology](synology-package.md).

...
| --- | --- | --- |
| Docker / Synology Container Manager | Publieke bèta `0.1.8` | Gratis server, browserinterface en lokaal Wi-Fi native streamen |
...
- **Docker-image:** `ghcr.io/mlt-solutions/bibliofuse-nas:0.1.8`

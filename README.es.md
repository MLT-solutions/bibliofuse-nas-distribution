...
| --- | --- | --- |
| Docker / Synology Container Manager | Beta pública `0.1.11` | Servidor gratuito, interfaz de navegador y streaming nativo por Wi-Fi local |
...
- **Imagen Docker:** `ghcr.io/mlt-solutions/bibliofuse-nas:0.1.11`

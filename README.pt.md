...
| --- | --- | --- |
| Docker / Synology Container Manager | Beta público `0.1.6` | Servidor, interface de navegador e streaming nativo por Wi-Fi local gratuitos |
...
- **Imagem Docker:** `ghcr.io/mlt-solutions/bibliofuse-nas:0.1.6`
